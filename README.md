...
It is a **role-playing productivity system** built for people who are serious about achieving their goals. Every mission you complete earns you XP. Every streak you maintain levels up your character. Fail a mission — and your warrior feels it.
...
### Analytics Screen
*Category-level mission breakdown — see exactly where you are winning and where you are falling behind.*
...
### Sharing Stats
*One-tap pixel-art stat card — shareable to any app. Show your level, streak, and XP anywhere.*
...
### Gamification Engine
- **XP System** — earn points for completing missions based on difficulty (Easy to Boss)
- **5 Level Tiers** — Rookie, Apprentice, Challenger, Expert, Legend
- **Pixel Character Sprite** — your on-screen warrior evolves visually with every level, drawn on canvas using 8x16 pixel grids
...
- Full **edit and fail** flows — fail a mission and it is logged with a timestamp

### Analytics and Insights
- **Category Analytics Screen** — breakdown of completed and failed missions by category
- **Weekly Report** — grade (S/A/B/C/D), XP earned, active days, streak, and performance score
- **Dashboard stats grid** — live streak, active goals, weekly focus percentage, monthly active days, failed count, freeze tokens
...
- Ranked by **Discipline Score** (a composite of XP, streak, and level)
...
### Share Your Stats
- One-tap **stat card sharing** — generates a pixel-art styled 800x400 PNG card using Android Canvas
...
Schema versioned from v1 to v7 with zero-data-loss migrations.
...
| Screen | Description |
|--------|-------------|
| `SplashScreen` | Animated entry with pixel logo |
| `OnboardingScreen` | First-time user setup and name input |
...
- Android SDK 26+
- A Firebase project with Realtime Database, Authentication, and FCM enabled
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/Karaniniiitd/do-it-now-motivation-tracker-app.git
   cd do-it-now-motivation-tracker-app
   ```
...
**Devesh Roy**  
[github.com/deveshroy11](https://github.com/deveshroy11)
